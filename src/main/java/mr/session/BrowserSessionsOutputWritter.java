 ...
 * @since 1.0.0
 */
public class BrowserSessionsOutputWritter implements IOutputWritter {
    private static final Logger logger = Logger.getLogger(BrowserSessionsOutputWritter.class);
    @Override
