 ...
 **/
public class LocalOutputToMySqlFormat extends OutputFormat<StatsBaseDimension, LocalOutputValue> {
     ...
     */
    @Override
    public RecordWriter<StatsBaseDimension, LocalOutputValue> getRecordWriter(TaskAttemptContext taskAttemptContext) throws IOException, InterruptedException {
     ...
     * 用于封装写出记录到mysql的信息
     */
    public static class OutputToMysqlRecordWritter extends RecordWriter<StatsBaseDimension,LocalOutputValue>{
         ...
         */
        @Override
        public void write(StatsBaseDimension key, LocalOutputValue value) throws IOException, InterruptedException {
            //获取kpi
